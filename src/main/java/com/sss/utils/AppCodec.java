...
public class AppCodec {
	...
	*/
	 ...
	 * @return
	 */
	public static String password(String password,String key) {
		return md5(encrypt(password, key));
	}
	...
	*/
	public static void main(String[] args) throws IOException {
	   ...
	   for ( int i = 0 ; i < 1 ; i ++) {   
	    String strEncrypto = AppCodec.encrypt(str, sKey);
	    System.out.println("被加密的字符串：" + str + "\r\n加密后的结果：" + strEncrypto);
	    System.out.println(md5(strEncrypto));
	    String strDecrypto = AppCodec.decrypt(strEncrypto, sKey);
